                ...
                <tr>
                    ...
                    <td>
                        <div class="hl-horse-cell">
                            ...
                            <img
                                src="/huhu/uploads/horses/<?= escapeHtml($horse['horse_image'] ?? 'horse_default.png') ?>"
                    ...
                    <td>
                        <div class="hl-actions">
                            ...
                            <a href="/huhu/views/horse_info.php?id=<?= (int)$horse['id_horse'] ?>">
                                👁
                            </a>

                            <a href="/huhu/views/update_horses_form.php?id=<?= (int)$horse['id_horse'] ?>">
                                ✏️
                            </a>
...
<div id="deleteModal" class="custom-modal hidden">
    <div class="modal-card">
        <div class="modal-body mt-3">
            ...
            <form action="/huhu/controller/delete_horses_ctrl.php" method="POST">
