...
<div class="dash-page">
    ...
    <div class="dash-grid">
        ...
        <a href="/huhu/views/add_horses_form.php" class="dash-card">
        ...
        <a href="/huhu/views/horses_list.php" class="dash-card">
            <div class="dash-card-icon">
        ...
        <a href="/huhu/views/create_organisateur.php" class="dash-card">
            <div class="dash-card-icon">
        ...
        <a href="/huhu/views/organisateur_auctions.php" class="dash-card">
            <div class="dash-card-icon">
